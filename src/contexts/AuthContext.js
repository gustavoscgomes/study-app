...
import React, { createContext, useState, useEffect } from 'react'; // React e hooks
import { onAuthStateChanged, signOut } from 'firebase/auth'; // Firebase para autenticação
...
export const AuthProvider = ({ children }) => {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, (user) => {
            setUser(user); // Atualiza o estado com o usuário atual (ou null se deslogado)
